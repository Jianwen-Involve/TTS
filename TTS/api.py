...
class TTS:
    ...
    def __init__(
        ...
        if model_path:
            self.load_tts_model_by_path(
                model_path, config_path, speakers_file_path=speakers_file_path, vocoder_path=vocoder_path, vocoder_config=vocoder_config_path, gpu=gpu
            )
    ...
    def tts(
        ...
        wav = self.synthesizer.tts(
            text=text,
            speaker_name="VCTK_kat_callaghan",
